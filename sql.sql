...
CREATE TABLE `AlphaProject`.`Profile` ( `id` INT(200) NOT NULL , `about` TEXT NOT NULL , `gender` TEXT NOT NULL , `dob` DATE NOT NULL , `group` VARCHAR(200)  NULL , `Role` TEXT NOT NULL, FOREIGN KEY (`id`) REFERENCES Users(`id`) ) ENGINE = InnoDB;


CREATE TABLE `AlphaProject`.`Admin` (`id` INT(10) NOT NULL , `Username` VARCHAR(200) NOT NULL , `Password` VARCHAR(23) NOT NULL ) ENGINE = InnoDB;

INSERT INTO `Admin` (`id`, `Username`, `Password`) VALUES ('1', 'admin@gmail.com', '0000');
